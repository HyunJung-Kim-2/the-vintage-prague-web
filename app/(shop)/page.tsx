          ...
          {categories.map((cat, i) => (
            <FadeIn key={cat.slug} delay={i * 0.08}>
              <Link
                ...
                className="group relative aspect-square bg-surface flex flex-col items-center justify-center border border-border hover:border-burgundy transition-colors block"
              >
